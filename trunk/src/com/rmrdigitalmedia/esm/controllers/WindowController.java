...
public class WindowController {
	...
	protected void createContents() {
		...
		pageSpaceDetail.setLayout(new FillLayout(SWT.VERTICAL));
		SashForm panels = new SashForm(pageSpaceDetail,SWT.NONE);
		...
		pageAdministration.setLayout(new FillLayout(SWT.VERTICAL));
		panels = new SashForm(pageAdministration,SWT.NONE);
		panels.setBackground(Constants.TITLEBAR_BGCOLOR);
		panels.setLayout(new FillLayout());
