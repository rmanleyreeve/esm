...
INSERT INTO VESSEL (NAME,IMO_NUMBER,TYPE,OWNER,CREATED_DATE) VALUES ('HMS Ark Royal','12345678','Aircraft Carrier','Royal Navy UK',CURRENT_TIMESTAMP());
...
VALUES 
('admin','pass','Esm','Administrator','ADMIN','System Administrator','ESM001',9, '1980-08-19',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP());
INSERT INTO ESM_USERS
(USERNAME,PASSWORD,FORENAME,SURNAME,RANK,JOB_TITLE,WORK_IDENTIFIER,ACCESS_LEVEL,DOB,CREATED_DATE,UPDATE_DATE) 
VALUES 
