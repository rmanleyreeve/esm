...
public class SpaceAuditClassificationView {
	...
	private static Label Separator(Composite comp, boolean hide) {
		Label separator = new Label(comp, SWT.SEPARATOR | SWT.HORIZONTAL
				| SWT.CENTER);
		final GridData gd = new GridData(SWT.FILL, SWT.CENTER, false, false, 5,
				1);
		gd.exclude = hide;
	...
	public static void buildPage(final Composite parent, final int spaceID) {
		...
		GridData gd_lblClassification = new GridData(SWT.FILL, SWT.CENTER,
				false, false, 1, 1);
		...
		lblClassification.setForeground(SWTResourceManager
		...
		GridData gd_lblComments = new GridData(SWT.FILL, SWT.CENTER, true,
				false, 1, 1);
		...
		try {
			aRow = SpaceClassificationAuditTable.getRow("SPACE_ID", ""
					+ spaceID);
		} catch (SQLException e1) {
			LogController.logEvent(SpaceAuditClassificationView.class, C.ERROR,
					e1);
		}
		empty = (aRow == null);
		...
		try {
			qText.add(0, null);
			qHints.add(0, null);
			qRows = SpaceClassificationQuestionsTable
		...
		if (!empty)
			q1_radio1.setSelection(aRow.getQ1Value() == 1);
		q1_radio2 = new Button(q1_col3, SWT.RADIO);
		q1_radio2.setText("Quite difficult");
		q1_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q1_radio2.setSelection(!aRow.isQ1ValueNull()
					&& aRow.getQ1Value() == 2);
		q1_radio3 = new Button(q1_col3, SWT.RADIO);
		q1_radio3.setText("Not difficult");
		q1_radio3.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q1_radio3.setSelection(!aRow.isQ1ValueNull()
					&& aRow.getQ1Value() == 3);
		Label q1_col4 = makeColumn4(tbl, false);
		if (q1_radio2.getSelection()) {
			q1_col4.setImage(C.getImage("amber.png"));
		}
		if (q1_radio3.getSelection()) {
			q1_col4.setImage(C.getImage("green.png"));
		}
		q1_col5 = MakeColumn5(tbl, false);
		if (!empty)
			q1_col5.setText(C.notNull(aRow.getQ1Comments()));
		...
		if (!empty)
			q2_radio1.setSelection(aRow.getQ2Value() == 1);
		q2_radio2 = new Button(q2_col3, SWT.RADIO);
		q2_radio2.setText("Quite difficult");
		q2_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q2_radio2.setSelection(aRow.getQ2Value() == 2);
		q2_radio3 = new Button(q2_col3, SWT.RADIO);
		q2_radio3.setText("Not difficult");
		q2_radio3.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q2_radio3.setSelection(aRow.getQ2Value() == 3);
		Label q2_col4 = makeColumn4(tbl, false);
		if (q2_radio2.getSelection()) {
			q2_col4.setImage(C.getImage("amber.png"));
		}
		if (q2_radio3.getSelection()) {
			q2_col4.setImage(C.getImage("green.png"));
		}
		q2_col5 = MakeColumn5(tbl, false);
		if (!empty)
			q2_col5.setText(C.notNull(aRow.getQ2Comments()));
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 3;
		show = false;
		try {
			SpaceChecklistAuditTable.Row r = SpaceChecklistAuditTable.getRow(
					"SPACE_ID", "" + spaceID);
			show = (r != null && (r.getQ7Boolean() != null && r.getQ7Boolean()
					.equals("Y")));
		} catch (SQLException e1) {
			LogController.logEvent(SpaceAuditClassificationView.class,
					C.WARNING, e1);
			e1.printStackTrace();
		}
		...
		if (!empty)
			q3_radio1.setSelection(aRow.getQ3Value() == 1);
		q3_radio2 = new Button(q3_col3, SWT.RADIO);
		q3_radio2.setText("Quite difficult");
		q3_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q3_radio2.setSelection(aRow.getQ2Value() == 2);
		q3_radio3 = new Button(q3_col3, SWT.RADIO);
		q3_radio3.setText("Not difficult");
		q3_radio3.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q3_radio3.setSelection(aRow.getQ3Value() == 3);
		Label q3_col4 = makeColumn4(tbl, !show);
		if (q3_radio2.getSelection()) {
			q3_col4.setImage(C.getImage("amber.png"));
		}
		if (q3_radio3.getSelection()) {
			q3_col4.setImage(C.getImage("green.png"));
		}
		q3_col5 = MakeColumn5(tbl, !show);
		if (!empty)
			q3_col5.setText(C.notNull(aRow.getQ3Comments()));
		...
		if (!empty)
			q4_radio1.setSelection(aRow.getQ4Value() == 1);
		q4_radio2 = new Button(q4_col3, SWT.RADIO);
		q4_radio2.setText("2");
		q4_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q4_radio2.setSelection(aRow.getQ4Value() == 2);
		q4_radio3 = new Button(q4_col3, SWT.RADIO);
		q4_radio3.setText("3");
		q4_radio3.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q4_radio3.setSelection(aRow.getQ4Value() == 3);
		q4_radio4 = new Button(q4_col3, SWT.RADIO);
		q4_radio4.setText("4");
		q4_radio4.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q4_radio4.setSelection(aRow.getQ4Value() == 4);
		q4_radio5 = new Button(q4_col3, SWT.RADIO);
		q4_radio5.setText("5");
		q4_radio5.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q4_radio5.setSelection(aRow.getQ4Value() == 5);
		Label q4_col4 = makeColumn4(tbl, false);
		if (q4_radio2.getSelection() || q4_radio3.getSelection()
				|| q4_radio4.getSelection()) {
			q4_col4.setImage(C.getImage("amber.png"));
		}
		if (q4_radio5.getSelection()) {
			q4_col4.setImage(C.getImage("green.png"));
		}
		q4_col5 = MakeColumn5(tbl, false);
		if (!empty)
			q4_col5.setText(C.notNull(aRow.getQ4Comments()));
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 5;
		...
		if (!empty)
			q5_radio1.setSelection(aRow.getQ5Value() == 1);
		q5_radio2 = new Button(q5_col3, SWT.RADIO);
		q5_radio2.setText("Fairly difficult");
		q5_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q5_radio2.setSelection(aRow.getQ5Value() == 2);
		q5_radio3 = new Button(q5_col3, SWT.RADIO);
		q5_radio3.setText("Not difficult");
		q5_radio3.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q5_radio3.setSelection(aRow.getQ5Value() == 3);
		Label q5_col4 = makeColumn4(tbl, false);
		if (q5_radio2.getSelection()) {
			q5_col4.setImage(C.getImage("amber.png"));
		}
		if (q5_radio3.getSelection()) {
			q5_col4.setImage(C.getImage("green.png"));
		}
		q5_col5 = MakeColumn5(tbl, false);
		if (!empty)
			q5_col5.setText(C.notNull(aRow.getQ5Comments()));
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 6;
		...
		if (!empty)
			q6_radio1.setSelection(aRow.getQ6Value() == 1);
		q6_radio2 = new Button(q6_col3, SWT.RADIO);
		q6_radio2.setText("Some difficulty");
		q6_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q6_radio2.setSelection(aRow.getQ6Value() == 2);
		q6_radio3 = new Button(q6_col3, SWT.RADIO);
		q6_radio3.setText("No difficulty");
		q6_radio3.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q6_radio3.setSelection(aRow.getQ6Value() == 3);
		Label q6_col4 = makeColumn4(tbl, false);
		if (q6_radio2.getSelection()) {
			q6_col4.setImage(C.getImage("amber.png"));
		}
		if (q6_radio3.getSelection()) {
			q6_col4.setImage(C.getImage("green.png"));
		}
		q6_col5 = MakeColumn5(tbl, false);
		if (!empty)
			q6_col5.setText(C.notNull(aRow.getQ6Comments()));
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 7;
		...
		if (q7_radio2.getSelection()) {
			q7_col4.setImage(C.getImage("green.png"));
		}
		q7_col5 = MakeColumn5(tbl, false);
		if (!empty)
			q7_col5.setText(C.notNull(aRow.getQ7Comments()));
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 8;
		...
		if (q8_radio2.getSelection()) {
			q8_col4.setImage(C.getImage("green.png"));
		}
		q8_col5 = MakeColumn5(tbl, false);
		if (!empty)
			q8_col5.setText(C.notNull(aRow.getQ8Comments()));
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
	...
	static void saveAudit(int spaceID) {
		...
		if (empty) {
			try {
				SpaceClassificationAuditTable.Row r = SpaceClassificationAuditTable
						.getRow();
				r.setSpaceID(spaceID);
				r.insert();
			} catch (SQLException e1) {
				LogController.logEvent(SpaceAuditClassificationView.class,
						C.FATAL, "ERROR INSERT SPACE CLASSIFICATION ROW", e1);
			}
		}
		SpaceClassificationAuditTable.Row aRow = null;
		try {
			...
			LogController.logEvent(SpaceAuditClassificationView.class, C.FATAL,
					"ERROR SELECT SPACE CLASSIFICATION ROW", ex);
		}
		if (aRow != null) {
			try {
				// 1
				if (q1_radio1.getSelection()) {
					...
					aRow.setQ1Value(2);
				} else if (q1_radio3.getSelection()) {
					aRow.setQ1Value(3);
				} else {
					aRow.setQ1Value(0);
				}
				// 2
				if (q2_radio1.getSelection()) {
					aRow.setQ2Value(1);
				} else if (q2_radio2.getSelection()) {
					aRow.setQ2Value(2);
				} else if (q2_radio3.getSelection()) {
					aRow.setQ2Value(3);
				} else {
					aRow.setQ2Value(0);
				}
				// 3
				if (show && q3_radio1.getSelection()) {
					aRow.setQ3Value(1);
				} else if (show && q3_radio2.getSelection()) {
					aRow.setQ3Value(2);
				} else if (show && q3_radio3.getSelection()) {
					aRow.setQ3Value(3);
				} else {
					aRow.setQ3Value(0);
				}
				...
				if (q4_radio1.getSelection()) {
					...
					aRow.setQ4Value(3);
				} else if (q4_radio4.getSelection()) {
					aRow.setQ4Value(4);
				} else if (q4_radio5.getSelection()) {
					aRow.setQ4Value(5);
				} else {
					aRow.setQ4Value(0);
				}
				// 5
				if (q5_radio1.getSelection()) {
					aRow.setQ5Value(1);
				} else if (q5_radio2.getSelection()) {
					aRow.setQ5Value(2);
				} else if (q5_radio3.getSelection()) {
					aRow.setQ5Value(3);
				} else {
					aRow.setQ5Value(0);
				}
				// 6
				if (q6_radio1.getSelection()) {
					aRow.setQ6Value(1);
				} else if (q6_radio2.getSelection()) {
					aRow.setQ6Value(2);
				} else if (q6_radio3.getSelection()) {
					aRow.setQ6Value(3);
				} else {
					aRow.setQ6Value(0);
				}
				...
				LogController.logEvent(SpaceAuditClassificationView.class,
						C.FATAL, "ERROR UPDATE SPACE CLASSIFICATION ROW", e);
			}
