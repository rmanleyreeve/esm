...
public class SpaceAuditChecklistView {
	...
	private static Label Separator(Composite comp, boolean hide) {
		Label separator = new Label(comp, SWT.SEPARATOR | SWT.HORIZONTAL
				| SWT.CENTER);
		final GridData gd = new GridData(SWT.FILL, SWT.CENTER, false, false, 4,
				1);
		gd.exclude = hide;
	...
	public static void buildPage(final Composite parent, final int spaceID) {
		...
		final ScrolledComposite scrollPanel = new ScrolledComposite(parent,
		...
		lblStatus.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, true,
				false, 1, 1));
		...
		GridData gd_lblStatusImg = new GridData(SWT.LEFT, SWT.CENTER, true,
				false, 2, 1);
		gd_lblStatusImg.horizontalIndent = 10;
		lblStatusImg.setLayoutData(gd_lblStatusImg);
		// progress image
		final int progress = (Integer) EsmApplication.appData
				.getField("SPACE_CHK_" + spaceID);
		lblStatusImg.setImage(C.progressImage(progress));
		...
		GridData gd_lblChecklist = new GridData(SWT.FILL, SWT.FILL, true,
				false, 1, 1);
		...
		GridData gd_lblHint = new GridData(SWT.FILL, SWT.CENTER, false, false,
				1, 1);
		...
		GridData gd_lblOptions = new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1);
		...
		GridData gd_lblComments = new GridData(SWT.FILL, SWT.CENTER, false,
				false, 1, 1);
		...
		try {
			qText.add(0, null);
			qHints.add(0, null);
			qRows = SpaceChecklistQuestionsTable
					.getRows("1=1 ORDER BY SEQUENCE ASC");
		...
		q1_lblH.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false,
				1, 1));
		q1_lblH.setBackground(C.APP_BGCOLOR);
		q1_lblH.setFont(C.FONT_9);
		q1_lblH.setText("Height:");
		q1_txtH = new Text(q1_col3, SWT.BORDER);
		GridData gd_q1_txtH = new GridData(SWT.FILL, SWT.CENTER, false, false,
				1, 1);
		...
		if (!empty) {
			q1_txtH.setText(C.notNull(aRow.getQ1DimsH()));
		}
		Label q1_lblW = new Label(q1_col3, SWT.NONE);
		q1_lblW.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false,
				1, 1));
		q1_lblW.setBackground(C.APP_BGCOLOR);
		q1_lblW.setFont(C.FONT_9);
		q1_lblW.setText("Width:");
		q1_txtW = new Text(q1_col3, SWT.BORDER);
		GridData gd_q1_txtW = new GridData(SWT.FILL, SWT.CENTER, false, false,
				1, 1);
		...
		if (!empty) {
			q1_txtW.setText(C.notNull(aRow.getQ1DimsW()));
		}
		Label q1_lblL = new Label(q1_col3, SWT.NONE);
		q1_lblL.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false,
				1, 1));
		q1_lblL.setBackground(C.APP_BGCOLOR);
		q1_lblL.setFont(C.FONT_9);
		q1_lblL.setText("Length:");
		q1_txtL = new Text(q1_col3, SWT.BORDER);
		GridData gd_q1_txtL = new GridData(SWT.FILL, SWT.TOP, false, false, 1,
				1);
		...
		if (!empty) {
			q1_txtL.setText(C.notNull(aRow.getQ1DimsL()));
		}
		q1_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q1_col4.setText(C.notNull(aRow.getQ1Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 2;
		Label q2_col1 = MakeColumn1(
				tbl,
				"Is the enclosed space Compartmentalised?\n(If so, describe internal layout)",
				false);
		...
		if (!empty)
			q2_radio1.setSelection(aRow.getQ2Boolean() != null
					&& aRow.getQ2Boolean().equals("Y"));
		q2_radio2 = new Button(q2_col3, SWT.RADIO);
		q2_radio2.setText("No");
		q2_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q2_radio2.setSelection(aRow.getQ2Boolean() != null
					&& aRow.getQ2Boolean().equals("N"));
		q2_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q2_col4.setText(C.notNull(aRow.getQ2Desc()));
		}
		sep = Separator(tbl, false);
		...
		if (!empty)
			q3_radio1.setSelection(aRow.getQ3Boolean() != null
					&& aRow.getQ3Boolean().equals("Y"));
		q3_radio2 = new Button(q3_col3, SWT.RADIO);
		q3_radio2.setText("No");
		q3_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q3_radio2.setSelection(aRow.getQ3Boolean() != null
					&& aRow.getQ3Boolean().equals("N"));
		q3_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q3_col4.setText(C.notNull(aRow.getQ3Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 4;
		...
		q4_radio1.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
				false, 2, 1));
		q4_radio1.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q4_radio1.setSelection(aRow.getQ4Boolean() != null
					&& aRow.getQ4Boolean().equals("Y"));
		q4_radio2 = new Button(q4_col3, SWT.RADIO);
		q4_radio2.setText("No");
		q4_radio2.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false,
				false, 2, 1));
		q4_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q4_radio2.setSelection(aRow.getQ4Boolean() != null
					&& aRow.getQ4Boolean().equals("N"));
		final Label q4_lblH = new Label(q4_col3, SWT.NONE);
		q4_lblH.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false,
				1, 1));
		...
		GridData gd_q4_txtH = new GridData(SWT.FILL, SWT.CENTER, false, false,
				1, 1);
		...
		if (!empty) {
			q4_txtH.setText(C.notNull(aRow.getQ4DimsH()));
		}
		q4_txtH.setVisible(q4_radio1.getSelection());
		q4_lblW = new Label(q4_col3, SWT.NONE);
		q4_lblW.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false,
				1, 1));
		...
		GridData gd_q4_txtW = new GridData(SWT.FILL, SWT.CENTER, false, false,
				1, 1);
		...
		if (!empty) {
			q4_txtW.setText(C.notNull(aRow.getQ4DimsW()));
		}
		...
		if (!empty) {
			q4_col4.setText(C.notNull(aRow.getQ4Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 5;
		...
		if (!empty)
			q5_radio1.setSelection(aRow.getQ5Boolean() != null
					&& aRow.getQ5Boolean().equals("Y"));
		q5_radio2 = new Button(q5_col3, SWT.RADIO);
		q5_radio2.setText("No");
		q5_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q5_radio2.setSelection(aRow.getQ5Boolean() != null
					&& aRow.getQ5Boolean().equals("N"));
		q5_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q5_col4.setText(C.notNull(aRow.getQ5Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 6;
		...
		if (!empty)
			q6_radio1.setSelection(aRow.getQ6Boolean() != null
					&& aRow.getQ6Boolean().equals("Y"));
		q6_radio2 = new Button(q6_col3, SWT.RADIO);
		q6_radio2.setText("No");
		q6_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q6_radio2.setSelection(aRow.getQ6Boolean() != null
					&& aRow.getQ6Boolean().equals("N"));
		q6_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q6_col4.setText(C.notNull(aRow.getQ6Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 7;
		...
		if (!empty)
			q7_radio1.setSelection(aRow.getQ7Boolean() != null
					&& aRow.getQ7Boolean().equals("Y"));
		q7_radio1.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
				false, 1, 1));
		q7_radio2 = new Button(q7_col3, SWT.RADIO);
		q7_radio2.setText("No");
		q7_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q7_radio2.setSelection(aRow.getQ7Boolean() != null
					&& aRow.getQ7Boolean().equals("N"));
		q7_radio2.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false,
				false, 2, 1));
		...
		q7_ratings.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false,
				false, 3, 1));
		...
		if (!empty)
			q7_rate_radio1.setSelection(aRow.getQ7Rating() == 1);
		...
		if (!empty)
			q7_rate_radio2.setSelection(aRow.getQ7Rating() == 2);
		...
		if (!empty)
			q7_rate_radio3.setSelection(aRow.getQ7Rating() == 3);
		...
		if (!empty) {
			q7_col4.setText(C.notNull(aRow.getQ7Comments()));
		}
		sep = Separator(tbl, false);
		if (q7_radio1.getSelection())
			q7_col1.setText(q7_txt + q7_txt_2);
		...
		final Label q8_col1 = MakeColumn1(tbl, q8_txt,
				!q7_radio1.getSelection());
		final Label q8_col2 = makeColumn2(tbl, qHints.elementAt(qNum),
				!q7_radio1.getSelection());
		...
		if (!empty)
			q8_radio1.setSelection(aRow.getQ8Boolean() != null
					&& aRow.getQ8Boolean().equals("Y"));
		q8_radio1.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
				false, 1, 1));
		q8_radio2 = new Button(q8_col3, SWT.RADIO);
		q8_radio2.setText("No");
		q8_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q8_radio2.setSelection(aRow.getQ8Boolean() != null
					&& aRow.getQ8Boolean().equals("N"));
		q8_radio2.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false,
				false, 2, 1));
		final Composite q8_ratings = new Composite(q8_col3, SWT.BORDER);
		q8_ratings.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false,
				false, 3, 1));
		...
		if (!empty)
			q8_rate_radio1.setSelection(aRow.getQ8Rating() == 1);
		...
		if (!empty)
			q8_rate_radio2.setSelection(aRow.getQ8Rating() == 2);
		...
		if (!empty)
			q8_rate_radio3.setSelection(aRow.getQ8Rating() == 3);
		...
		if (!empty) {
			q8_col4.setText(C.notNull(aRow.getQ8Comments()));
		}
		...
		final Label q9_col1 = MakeColumn1(tbl, q9_txt,
				!q7_radio1.getSelection());
		final Label q9_col2 = makeColumn2(tbl, qHints.elementAt(qNum),
				!q7_radio1.getSelection());
		...
		if (!empty)
			q9_radio1.setSelection(aRow.getQ9Boolean() != null
					&& aRow.getQ9Boolean().equals("Y"));
		q9_radio1.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
				false, 1, 1));
		q9_radio2 = new Button(q9_col3, SWT.RADIO);
		q9_radio2.setText("No");
		q9_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q9_radio2.setSelection(aRow.getQ9Boolean() != null
					&& aRow.getQ9Boolean().equals("N"));
		q9_radio2.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false,
				false, 2, 1));
		final Composite q9_ratings = new Composite(q9_col3, SWT.BORDER);
		q9_ratings.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false,
				false, 3, 1));
		...
		if (!empty)
			q9_rate_radio1.setSelection(aRow.getQ9Rating() == 1);
		...
		if (!empty)
			q9_rate_radio2.setSelection(aRow.getQ9Rating() == 2);
		...
		if (!empty)
			q9_rate_radio3.setSelection(aRow.getQ9Rating() == 3);
		...
		final Label q10_col1 = MakeColumn1(tbl, q10_txt,
				!q7_radio1.getSelection());
		final Label q10_col2 = makeColumn2(tbl, qHints.elementAt(qNum),
				!q7_radio1.getSelection());
		final Composite q10_col3 = makeColumn3(tbl, 3,
				!q7_radio1.getSelection());
		q10_radio1 = new Button(q10_col3, SWT.RADIO);
		q10_radio1.setText("Yes");
		q10_radio1.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q10_radio1.setSelection(aRow.getQ10Boolean() != null
					&& aRow.getQ10Boolean().equals("Y"));
		q10_radio1.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
				false, 1, 1));
		q10_radio2 = new Button(q10_col3, SWT.RADIO);
		q10_radio2.setText("No");
		q10_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q10_radio2.setSelection(aRow.getQ10Boolean() != null
					&& aRow.getQ10Boolean().equals("N"));
		q10_radio2.setLayoutData(new GridData(SWT.LEFT, SWT.CENTER, false,
				false, 2, 1));
		final Composite q10_ratings = new Composite(q10_col3, SWT.BORDER);
		q10_ratings.setLayoutData(new GridData(SWT.CENTER, SWT.CENTER, false,
				false, 3, 1));
		...
		if (!empty)
			q10_rate_radio1.setSelection(aRow.getQ10Rating() == 1);
		...
		if (!empty)
			q10_rate_radio2.setSelection(aRow.getQ10Rating() == 2);
		...
		if (!empty)
			q10_rate_radio3.setSelection(aRow.getQ10Rating() == 3);
		...
		if (!empty)
			q11_radio1.setSelection(aRow.getQ11Boolean() != null
					&& aRow.getQ11Boolean().equals("Y"));
		q11_radio2 = new Button(q11_col3, SWT.RADIO);
		q11_radio2.setText("No");
		q11_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q11_radio2.setSelection(aRow.getQ11Boolean() != null
					&& aRow.getQ11Boolean().equals("N"));
		q11_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q11_col4.setText(C.notNull(aRow.getQ11Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 12;
		...
		if (!empty)
			q12_radio1.setSelection(aRow.getQ12Boolean() != null
					&& aRow.getQ12Boolean().equals("Y"));
		q12_radio2 = new Button(q12_col3, SWT.RADIO);
		q12_radio2.setText("No");
		q12_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q12_radio2.setSelection(aRow.getQ12Boolean() != null
					&& aRow.getQ12Boolean().equals("N"));
		q12_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q12_col4.setText(C.notNull(aRow.getQ12Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 13;
		...
		if (!empty)
			q13_radio1.setSelection(aRow.getQ13Boolean() != null
					&& aRow.getQ13Boolean().equals("Y"));
		q13_radio2 = new Button(q13_col3, SWT.RADIO);
		q13_radio2.setText("No");
		q13_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q13_radio2.setSelection(aRow.getQ13Boolean() != null
					&& aRow.getQ13Boolean().equals("N"));
		q13_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q13_col4.setText(C.notNull(aRow.getQ13Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 14;
		...
		if (!empty)
			q14_radio1.setSelection(aRow.getQ14Boolean() != null
					&& aRow.getQ14Boolean().equals("Y"));
		q14_radio2 = new Button(q14_col3, SWT.RADIO);
		q14_radio2.setText("No");
		q14_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q14_radio2.setSelection(aRow.getQ14Boolean() != null
					&& aRow.getQ14Boolean().equals("N"));
		q14_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q14_col4.setText(C.notNull(aRow.getQ14Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 15;
		...
		if (!empty)
			q15_radio1.setSelection(aRow.getQ15Boolean() != null
					&& aRow.getQ15Boolean().equals("Y"));
		q15_radio2 = new Button(q15_col3, SWT.RADIO);
		q15_radio2.setText("No");
		q15_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q15_radio2.setSelection(aRow.getQ15Boolean() != null
					&& aRow.getQ15Boolean().equals("N"));
		q15_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q15_col4.setText(C.notNull(aRow.getQ15Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 16;
		...
		if (!empty)
			q16_radio1.setSelection(aRow.getQ16Boolean() != null
					&& aRow.getQ16Boolean().equals("Y"));
		q16_radio2 = new Button(q16_col3, SWT.RADIO);
		q16_radio2.setText("No");
		q16_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q16_radio2.setSelection(aRow.getQ16Boolean() != null
					&& aRow.getQ16Boolean().equals("N"));
		q16_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q16_col4.setText(C.notNull(aRow.getQ16Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		qNum = 17;
		...
		if (!empty)
			q17_radio1.setSelection(aRow.getQ17Boolean() != null
					&& aRow.getQ17Boolean().equals("Y"));
		q17_radio2 = new Button(q17_col3, SWT.RADIO);
		q17_radio2.setText("No");
		q17_radio2.setBackground(C.APP_BGCOLOR);
		if (!empty)
			q17_radio2.setSelection(aRow.getQ17Boolean() != null
					&& aRow.getQ17Boolean().equals("N"));
		q17_col4 = MakeColumn4(tbl, false);
		if (!empty) {
			q17_col4.setText(C.notNull(aRow.getQ17Comments()));
		}
		sep = Separator(tbl, false);
		// -------------------------------------------------------------------------------------------------------
		// end loop
		...
		q7_radio1.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent arg0) {
				...
				((ScrolledComposite) comp.getParent()).setMinSize(comp
		...
		btnReturn.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false,
				true, 1, 1));
		...
		btnSave.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, true,
				1, 1));
	...
	static void saveAudit(int spaceID) {
		...
		if (empty) {
			try {
				SpaceChecklistAuditTable.Row r = SpaceChecklistAuditTable
						.getRow();
				r.setSpaceID(spaceID);
				r.insert();
			} catch (SQLException e1) {
				LogController.logEvent(SpaceAuditChecklistView.class, C.FATAL,
						"ERROR INSERT SPACE CHECKLIST ROW", e1);
			}
		}
		SpaceChecklistAuditTable.Row aRow = null;
		try {
			...
			LogController.logEvent(SpaceAuditChecklistView.class, C.FATAL,
					"ERROR SELECT SPACE CHECKLIST ROW", ex);
		}
		if (aRow != null) {
			try {
				// 1
				...
				if (q1_col4.getText() != null)
					aRow.setQ1Comments(q1_col4.getText());
				// 2
				aRow.setQ2Boolean(C.getRB(q2_radio1, q2_radio2));
				if (q2_col4.getText() != null)
					aRow.setQ2Desc(q2_col4.getText());
				// 3
				aRow.setQ3Boolean(C.getRB(q3_radio1, q3_radio2));
				if (q3_col4.getText() != null)
					aRow.setQ3Comments(q3_col4.getText());
				// 4
				...
				aRow.setQ4DimsW((q4_radio1.getSelection()) ? q4_txtW.getText()
						: "");
				if (q4_col4.getText() != null)
					aRow.setQ4Comments(q4_col4.getText());
				// 5
				aRow.setQ5Boolean(C.getRB(q5_radio1, q5_radio2));
				if (q5_col4.getText() != null)
					aRow.setQ5Comments(q5_col4.getText());
				// 6
				aRow.setQ6Boolean(C.getRB(q6_radio1, q6_radio2));
				if (q6_col4.getText() != null)
					aRow.setQ6Comments(q6_col4.getText());
				// 7
				aRow.setQ7Boolean(C.getRB(q7_radio1, q7_radio2));
				if (q7_radio1.getSelection()) {
					if (q7_rate_radio1.getSelection()) {
						aRow.setQ7Rating(1);
					} else if (q7_rate_radio2.getSelection()) {
						aRow.setQ7Rating(2);
					} else if (q7_rate_radio3.getSelection()) {
						aRow.setQ7Rating(3);
					}
				} else {
					aRow.setQ7Rating(0);
				}
				if (q7_col4.getText() != null)
					aRow.setQ7Comments(q7_col4.getText());
				// 8
				if (q7_radio1.getSelection()) {
					aRow.setQ8Boolean(C.getRB(q8_radio1, q8_radio2));
					if (q8_radio1.getSelection()) {
						if (q8_rate_radio1.getSelection()) {
							aRow.setQ8Rating(1);
						} else if (q8_rate_radio2.getSelection()) {
							aRow.setQ8Rating(2);
						} else if (q8_rate_radio3.getSelection()) {
							aRow.setQ8Rating(3);
						}
					} else {
						aRow.setQ8Rating(0);
				...
				if (q8_col4.getText() != null)
					aRow.setQ8Comments(q8_col4.getText());
				// 9
				if (q7_radio1.getSelection()) {
					aRow.setQ9Boolean(C.getRB(q9_radio1, q9_radio2));
					if (q9_radio1.getSelection()) {
						if (q9_rate_radio1.getSelection()) {
							aRow.setQ9Rating(1);
						} else if (q9_rate_radio2.getSelection()) {
							aRow.setQ9Rating(2);
						} else if (q9_rate_radio3.getSelection()) {
							aRow.setQ9Rating(3);
						}
					} else {
						aRow.setQ9Rating(0);
				...
				if (q9_col4.getText() != null)
					aRow.setQ9Comments(q9_col4.getText());
				// 10
				if (q7_radio1.getSelection()) {
					aRow.setQ10Boolean(C.getRB(q10_radio1, q10_radio2));
					if (q10_radio1.getSelection()) {
						if (q10_rate_radio1.getSelection()) {
							aRow.setQ10Rating(1);
						} else if (q10_rate_radio2.getSelection()) {
							aRow.setQ10Rating(2);
						} else if (q10_rate_radio3.getSelection()) {
							aRow.setQ10Rating(3);
						}
					} else {
						aRow.setQ10Rating(0);
				...
				if (q10_col4.getText() != null)
					aRow.setQ10Comments(q10_col4.getText());
				// 11
				aRow.setQ11Boolean(C.getRB(q11_radio1, q11_radio2));
				if (q11_col4.getText() != null)
					aRow.setQ11Comments(q11_col4.getText());
				// 12
				aRow.setQ12Boolean(C.getRB(q12_radio1, q12_radio2));
				if (q12_col4.getText() != null)
					aRow.setQ12Comments(q12_col4.getText());
				// 13
				aRow.setQ13Boolean(C.getRB(q13_radio1, q13_radio2));
				if (q13_col4.getText() != null)
					aRow.setQ13Comments(q13_col4.getText());
				// 14
				aRow.setQ14Boolean(C.getRB(q14_radio1, q14_radio2));
				if (q14_col4.getText() != null)
					aRow.setQ14Comments(q14_col4.getText());
				// 15
				aRow.setQ15Boolean(C.getRB(q15_radio1, q15_radio2));
				if (q15_col4.getText() != null)
					aRow.setQ15Comments(q15_col4.getText());
				// 16
				aRow.setQ16Boolean(C.getRB(q16_radio1, q16_radio2));
				if (q16_col4.getText() != null)
					aRow.setQ16Comments(q16_col4.getText());
				// 17
				aRow.setQ17Boolean(C.getRB(q17_radio1, q17_radio2));
				if (q17_col4.getText() != null)
					aRow.setQ17Comments(q17_col4.getText());
				// commit the transaction
				aRow.update();
			} catch (SQLException e) {
				LogController.logEvent(SpaceAuditChecklistView.class, C.FATAL,
						"ERROR UPDATE SPACE CHECKLIST ROW", e);
			}
