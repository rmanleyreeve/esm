...
public class AddUserForm {
	...
	public boolean complete() {
		...
		GridData gd_forename = new GridData(SWT.LEFT, SWT.CENTER, true, false,
				3, 1);
		...
		GridData gd_surname = new GridData(SWT.LEFT, SWT.CENTER, false, false,
				3, 1);
		...
		GridData gd_rank = new GridData(SWT.LEFT, SWT.CENTER, false, false, 3,
				1);
		...
		GridData gd_jobtitle = new GridData(SWT.LEFT, SWT.CENTER, false, false,
				3, 1);
		...
		GridData gd_workid = new GridData(SWT.LEFT, SWT.CENTER, false, false,
				3, 1);
		...
		String[] levels = { "Disabled", "Moderated User", "Approved User",
				"User with Sign-Off" };
		...
		GridData gd_access = new GridData(SWT.LEFT, SWT.CENTER, false, false,
				3, 1);
		...
		ok.addSelectionListener(new SelectionAdapter() {
			...
			public void widgetSelected(SelectionEvent e) {
				Text[] fields = { username, password, forename, surname, rank,
						jobtitle, workid };
				Validation.validateFields(fields);
				Combo[] dates = { dd, mm, yyyy };
				Validation.validateDates(dates);
				accesslevel = (Integer) accessLevels.getData(accessLevels
						.getText());
				...
				if (Validation.validateFields(fields)
					...
					try {
						...
						row.setDob(yyyy.getText() + "-" + mm.getText() + "-"
								+ dd.getText());
