...
/** Strongly typed access to the database table "ENTRYPOINT_COMMENTS".
 *
 ...
 *
 */
public class EntrypointCommentsTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "ENTRYPOINT_COMMENTS";
    ...
    {
        idColumnName , entrypointIDColumnName , authorIDColumnName , commentColumnName , createdDateColumnName , updateDateColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockEntrypointCommentsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( EntrypointCommentsTable.Implementation instance  )
    {
        imp = instance ;
    }
