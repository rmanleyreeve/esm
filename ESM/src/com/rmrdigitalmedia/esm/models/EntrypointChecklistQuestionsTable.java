...
/** Strongly typed access to the database table "ENTRYPOINT_CHECKLIST_QUESTIONS".
 *
 ...
 *
 */
public class EntrypointChecklistQuestionsTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "ENTRYPOINT_CHECKLIST_QUESTIONS";
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockEntrypointChecklistQuestionsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( EntrypointChecklistQuestionsTable.Implementation instance  )
    {
        imp = instance ;
    }
