...
/** Strongly typed access to the database table "SPACE_CLASSIFICATION_QUESTIONS".
 *
 ...
 *
 */
public class SpaceClassificationQuestionsTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "SPACE_CLASSIFICATION_QUESTIONS";
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockSpaceClassificationQuestionsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( SpaceClassificationQuestionsTable.Implementation instance  )
    {
        imp = instance ;
    }
