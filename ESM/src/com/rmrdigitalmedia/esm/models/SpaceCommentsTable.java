 ...
 *
 */
public class SpaceCommentsTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "SPACE_COMMENTS";
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockSpaceCommentsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( SpaceCommentsTable.Implementation instance  )
    {
        imp = instance ;
    }
