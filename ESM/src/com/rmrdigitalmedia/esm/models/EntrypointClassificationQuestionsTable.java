...
/** Strongly typed access to the database table "ENTRYPOINT_CLASSIFICATION_QUESTIONS".
 *
 ...
 *
 */
public class EntrypointClassificationQuestionsTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "ENTRYPOINT_CLASSIFICATION_QUESTIONS";

    public static final String idColumnName = "ID";
    public static final String qTextColumnName = "Q_TEXT";
    public static final String qHintColumnName = "Q_HINT";
    public static final String sequenceColumnName = "SEQUENCE";

    private static String[] allColumns =
    {
        idColumnName , qTextColumnName , qHintColumnName , sequenceColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockEntrypointClassificationQuestionsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( EntrypointClassificationQuestionsTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.qText = data[1];
                this.qHint = data[2];
                this.sequence =  Str.toInt( data[3] );
        ...
        private Map buildDataMap()
        {
            ...
            data.put( qTextColumnName , this.qText );
            data.put( qHintColumnName , this.qHint );
            data.put( sequenceColumnName , String.valueOf(  this.sequence ) );
            return data ;
        }
