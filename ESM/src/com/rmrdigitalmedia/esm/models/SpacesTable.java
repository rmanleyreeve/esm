...
public class SpacesTable
{
    ...
    public static final String vesselNameColumnName = "VESSEL_NAME";
    ...
    {
        idColumnName , vesselNameColumnName , nameColumnName , descriptionColumnName , authorIDColumnName , createdDateColumnName , updateDateColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockSpacesTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( SpacesTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Map buildDataMap()
        {
            ...
            data.put( vesselNameColumnName , this.vesselName );
