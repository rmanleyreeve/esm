...
/** Strongly typed access to the database table "ENTRY_CLASSIFICATION_QUESTIONS".
 *
 ...
 *
 */
public class EntryClassificationQuestionsTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "ENTRY_CLASSIFICATION_QUESTIONS";
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockEntryClassificationQuestionsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( EntryClassificationQuestionsTable.Implementation instance  )
    {
        imp = instance ;
    }
