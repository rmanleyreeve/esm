package com.rmrdigitalmedia.esm.audits;
...
public class EntryAuditPage1 {
	...
	public static Group buildPage(final Composite comp, int entryID) {
		...
		q1_radio2.addSelectionListener(new SelectionAdapter() {
			@Override
			public void widgetSelected(SelectionEvent arg0) {
				System.out.println(q1_radio1.getSelection());
				System.out.println(q1_radio2.getSelection());
