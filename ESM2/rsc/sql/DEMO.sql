...
INSERT INTO VESSEL (ID,NAME,IMO_NUMBER,TYPE_ID,OWNER,CREATED_DATE, UPDATE_DATE, REMOTE_IDENTIFIER) VALUES (1,'HMS Shiptalk','12345678',1,'Shiptalk UK',CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(),'25377-46325-28882');

INSERT INTO ESM_USERS
(USERNAME,PASSWORD,FORENAME,SURNAME,RANK,WORK_IDENTIFIER,ACCESS_LEVEL,DOB,COMMENT,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER) 
VALUES 
('admin','pass','John','Smith','Captain','ESM001',9, '1980-08-19','Admin user',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');
INSERT INTO ESM_USERS
(USERNAME,PASSWORD,FORENAME,SURNAME,RANK,WORK_IDENTIFIER,ACCESS_LEVEL,DOB,COMMENT,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER) 
VALUES 
('user','pass','Fred','Bloggs','Rating','ESM123',1, '1974-02-11','Basic user - comments etc need approval',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');
INSERT INTO ESM_USERS
(USERNAME,PASSWORD,FORENAME,SURNAME,RANK,WORK_IDENTIFIER,ACCESS_LEVEL,DOB,COMMENT,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER) 
VALUES 
('user2','pass','Jack','Sparrow','Seaman','ESM987',2, '1984-01-01','Basic user level 2 - comments are automatically approved',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');

INSERT INTO SPACES (VESSEL_NAME,NAME,DESCRIPTION,AUTHOR_ID,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER)
VALUES ((SELECT TOP 1 NAME FROM VESSEL),'Forepeak Tank','The extreme forward lower compartment or tank usually used for trimming or storage in a ship',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');
INSERT INTO SPACES (VESSEL_NAME,NAME,DESCRIPTION,AUTHOR_ID,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER)
VALUES ((SELECT TOP 1 NAME FROM VESSEL),'Chain Locker','A forward compartment in the lower part of a ship for stowing the chain cable',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');
INSERT INTO SPACES (VESSEL_NAME,NAME,DESCRIPTION,AUTHOR_ID,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER)
VALUES ((SELECT TOP 1 NAME FROM VESSEL),'Ballast Tank','a tank or compartment either at the bottom of a ship or on the sides, which is filled with liquids for stability of the ship',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');
INSERT INTO SPACES (VESSEL_NAME,NAME,DESCRIPTION,AUTHOR_ID,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER)
VALUES ((SELECT TOP 1 NAME FROM VESSEL),'Pipe Tunnel','An underground or underwater passage.',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');

INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER)
VALUES (1,'Forepeak Tank Hatch','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');
INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER)
VALUES (1,'Forepeak Tank Ladder','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');
INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER)
VALUES (1,'Forepeak Tank Door','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');
INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER)
VALUES (2,'Chain Locker Door','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');
INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER)
VALUES (3,'Ballast Tank Lid','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');
INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,CREATED_DATE,UPDATE_DATE,REMOTE_IDENTIFIER)
VALUES (4,'Pipe Tunnel Hatch','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),'25377-46325-28882');

INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,CREATED_DATE,UPDATE_DATE,APPROVED,REMOTE_IDENTIFIER) 
VALUES (1,1,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),TRUE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,CREATED_DATE,UPDATE_DATE,APPROVED,REMOTE_IDENTIFIER) 
VALUES (1,2,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),FALSE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,CREATED_DATE,UPDATE_DATE,APPROVED,REMOTE_IDENTIFIER) 
VALUES (2,1,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),TRUE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,CREATED_DATE,UPDATE_DATE,APPROVED,REMOTE_IDENTIFIER) 
VALUES (2,2,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),FALSE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,CREATED_DATE,UPDATE_DATE,APPROVED,REMOTE_IDENTIFIER)
VALUES (3,1,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),TRUE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,CREATED_DATE,UPDATE_DATE,APPROVED,REMOTE_IDENTIFIER)
VALUES (3,2,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),TRUE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,CREATED_DATE,UPDATE_DATE,APPROVED,REMOTE_IDENTIFIER)
VALUES (4,1,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),TRUE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,CREATED_DATE,UPDATE_DATE,APPROVED,REMOTE_IDENTIFIER)
VALUES (4,2,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',CURRENT_TIMESTAMP(),CURRENT_TIMESTAMP(),TRUE,'25377-46325-28882');
