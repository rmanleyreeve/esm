-- Videotel ESM application database demo & testing file
-- rmrdigitalmedia.com, shiptalk.com (c)2014
...
CREATE TABLE ESM_USERS (
	...
	`REMOTE_IDENTIFIER` VARCHAR(20) DEFAULT '##REMOTEID##',
	PRIMARY KEY (ID)
);
...
INSERT INTO VESSEL_CATEGORIES (NAME) VALUES ('Vessel');
INSERT INTO VESSEL_CATEGORIES (NAME) VALUES ('Installation');

INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Barge Systems');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Bulk Carrier');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Buoy Handling Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Cable Laying Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Car Carrier');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Chemical Tanker');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Coast Guard Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(2, 'Compliant Tower');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(2, 'Condeep Platform');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Container Ship');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Container Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Diving Support Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Dredgers');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(2, 'Drill Ship');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Fire Fighting Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Fishing Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(2, 'Fixed Platform');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(2, 'Floating Production Systems');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(2, 'FPSO Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'General Cargo');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(2, 'Gravity Based Structure');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Icebreaker');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(2, 'Jack-up Drilling Rig');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Livestock Carrier');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'LNG Tanker');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Log Carrier');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'LPG Tanker');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Offshore Supply');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Offshore Support');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Oil Tanker');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Paper Carrier');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Passenger Ship');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Patrol Boat');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Pilot Boat');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Pipe Laying Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Reefer Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Research Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'RO-RO Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(2, 'Semi-submersible Platform');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(2, 'Spar Platform');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(2, 'Tension Leg Platform');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Tugs');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Turbine Installation Vessel');
INSERT INTO VESSEL_TYPES (CATEGORY_ID, NAME) VALUES(1, 'Yacht');
...
INSERT INTO LICENSE (LICENSEKEY, VERIFIED_DATE, REMOTE_IDENTIFIER) VALUES ('25377-46325-28882',CURRENT_TIMESTAMP(),'25377-46325-28882');

INSERT INTO VESSEL (ID,NAME,IMO_NUMBER,TYPE_ID,OWNER,REMOTE_IDENTIFIER) VALUES (1,'HMS Shiptalk','12345678',1,'Shiptalk UK','25377-46325-28882');

INSERT INTO ESM_USERS
(USERNAME,PASSWORD,FORENAME,SURNAME,RANK,WORK_IDENTIFIER,ACCESS_LEVEL,DOB,COMMENT,REMOTE_IDENTIFIER) 
VALUES 
('admin','1a1dc91c907325c69271ddf0c944bc72','John','Smith','Captain','ESM001',9, '1980-08-19','Admin user','25377-46325-28882');
INSERT INTO ESM_USERS
(USERNAME,PASSWORD,FORENAME,SURNAME,RANK,WORK_IDENTIFIER,ACCESS_LEVEL,DOB,COMMENT,REMOTE_IDENTIFIER) 
VALUES 
('user','1a1dc91c907325c69271ddf0c944bc72','Fred','Bloggs','Rating','ESM123',1, '1974-02-11','Basic user - comments etc need approval','25377-46325-28882');
INSERT INTO ESM_USERS
(USERNAME,PASSWORD,FORENAME,SURNAME,RANK,WORK_IDENTIFIER,ACCESS_LEVEL,DOB,COMMENT,REMOTE_IDENTIFIER) 
VALUES 
('user2','1a1dc91c907325c69271ddf0c944bc72','Jack','Sparrow','Seaman','ESM987',2, '1984-01-01','Basic user level 2 - comments are automatically approved','25377-46325-28882');

INSERT INTO SPACES (VESSEL_NAME,NAME,DESCRIPTION,AUTHOR_ID,REMOTE_IDENTIFIER)
VALUES ((SELECT TOP 1 NAME FROM VESSEL),'Forepeak Tank','The extreme forward lower compartment or tank usually used for trimming or storage in a ship',1,'25377-46325-28882');
INSERT INTO SPACES (VESSEL_NAME,NAME,DESCRIPTION,AUTHOR_ID,REMOTE_IDENTIFIER)
VALUES ((SELECT TOP 1 NAME FROM VESSEL),'Chain Locker','A forward compartment in the lower part of a ship for stowing the chain cable',1,'25377-46325-28882');
INSERT INTO SPACES (VESSEL_NAME,NAME,DESCRIPTION,AUTHOR_ID,REMOTE_IDENTIFIER)
VALUES ((SELECT TOP 1 NAME FROM VESSEL),'Ballast Tank','a tank or compartment either at the bottom of a ship or on the sides, which is filled with liquids for stability of the ship',1,'25377-46325-28882');
INSERT INTO SPACES (VESSEL_NAME,NAME,DESCRIPTION,AUTHOR_ID,REMOTE_IDENTIFIER)
VALUES ((SELECT TOP 1 NAME FROM VESSEL),'Pipe Tunnel','An underground or underwater passage.',1,'25377-46325-28882');

INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,REMOTE_IDENTIFIER)
VALUES (1,'Forepeak Tank Hatch','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,'25377-46325-28882');
INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,REMOTE_IDENTIFIER)
VALUES (1,'Forepeak Tank Ladder','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,'25377-46325-28882');
INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,REMOTE_IDENTIFIER)
VALUES (1,'Forepeak Tank Door','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,'25377-46325-28882');
INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,REMOTE_IDENTIFIER)
VALUES (2,'Chain Locker Door','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,'25377-46325-28882');
INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,REMOTE_IDENTIFIER)
VALUES (3,'Ballast Tank Lid','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,'25377-46325-28882');
INSERT INTO ENTRYPOINTS (SPACE_ID,NAME,DESCRIPTION,AUTHOR_ID,REMOTE_IDENTIFIER)
VALUES (4,'Pipe Tunnel Hatch','Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua.',1,'25377-46325-28882');

INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,APPROVED,REMOTE_IDENTIFIER) 
VALUES (1,1,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',TRUE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,APPROVED,REMOTE_IDENTIFIER) 
VALUES (1,2,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',FALSE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,APPROVED,REMOTE_IDENTIFIER) 
VALUES (2,1,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',TRUE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,APPROVED,REMOTE_IDENTIFIER) 
VALUES (2,2,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',FALSE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,APPROVED,REMOTE_IDENTIFIER)
VALUES (3,1,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',TRUE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,APPROVED,REMOTE_IDENTIFIER)
VALUES (3,2,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',TRUE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,APPROVED,REMOTE_IDENTIFIER)
VALUES (4,1,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',TRUE,'25377-46325-28882');
INSERT INTO SPACE_COMMENTS(SPACE_ID,AUTHOR_ID,COMMENT,APPROVED,REMOTE_IDENTIFIER)
VALUES (4,2,'Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur.',TRUE,'25377-46325-28882');
