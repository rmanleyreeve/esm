...
VALUES 
('admin','pass','John','Smith','Captain','ESM001',9, '1980-08-19','Admin user','25377-46325-28882');
INSERT INTO ESM_USERS
(USERNAME,PASSWORD,FORENAME,SURNAME,RANK,WORK_IDENTIFIER,ACCESS_LEVEL,DOB,COMMENT,REMOTE_IDENTIFIER) 
VALUES 
('user','pass','Fred','Bloggs','Rating','ESM123',1, '1974-02-11','Basic user - comments etc need approval','25377-46325-28882');
INSERT INTO ESM_USERS
(USERNAME,PASSWORD,FORENAME,SURNAME,RANK,WORK_IDENTIFIER,ACCESS_LEVEL,DOB,COMMENT,REMOTE_IDENTIFIER) 
VALUES 
('user2','pass','Jack','Sparrow','Seaman','ESM987',2, '1984-01-01','Basic user level 2 - comments are automatically approved','25377-46325-28882');
