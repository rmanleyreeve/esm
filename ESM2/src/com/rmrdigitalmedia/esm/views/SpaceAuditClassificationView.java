...
public class SpaceAuditClassificationView {
	...
	public static void buildPage(final Composite parent, final int spaceID) {
		...
		q3_radio2.setText("Yes with difficulty");
		...
		q3_radio3.setText("Yes without difficulty");
		...
		q5_radio2.setText("Quite difficult");
		...
		if(aRow != null) {
			try {
				...
				if(AuditController.isSpaceSignedOff(spaceID) && !newVals.equals(currentVals)) {
					...
					LogController.log("Revoking Signoff status, space classification audit data has changed");
