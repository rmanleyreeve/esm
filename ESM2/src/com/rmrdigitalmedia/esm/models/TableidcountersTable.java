...
/** Strongly typed access to the database table "TABLEIDCOUNTERS".
 *
 ...
 *
 */
public class TableidcountersTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "TABLEIDCOUNTERS";

    public static final String tablenameColumnName = "TABLENAME";
    public static final String counterColumnName = "COUNTER";
    public static final String skipColumnName = "SKIP";

    private static String[] allColumns =
    {
        tablenameColumnName , counterColumnName , skipColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockTableidcountersTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( TableidcountersTable.Implementation instance  )
    {
        imp = instance ;
    }
