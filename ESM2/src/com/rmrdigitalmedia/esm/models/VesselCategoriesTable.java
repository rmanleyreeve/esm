...
/** Strongly typed access to the database table "VESSEL_CATEGORIES".
 *
 ...
 *
 */
public class VesselCategoriesTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "VESSEL_CATEGORIES";
    ...
    {
        idColumnName , nameColumnName , createdDateColumnName , deletedColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockVesselCategoriesTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( VesselCategoriesTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.name = data[1];
                this.createdDate = Str.toTimestamp( data[2] );
                this.deleted = data[3];
