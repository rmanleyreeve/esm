...
public class PhotoDataTable
{
    ...
    {
        idColumnName , dataFullColumnName , dataThumbColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockPhotoDataTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( PhotoDataTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        public void setDataThumb( String dataThumb )
        {
