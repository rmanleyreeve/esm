    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.updateDate = Str.toTimestamp( data[44] );
                this.remoteIdentifier = data[45];
