...
public class VesselTable
{
    ...
    public static final String typeIDColumnName = "TYPE_ID";
    ...
    public static class Row
    {
        ...
        private int typeID ;
        private boolean typeIDNull = true ;
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.name = data[1];
                this.imoNumber = data[2];
                this.typeIDNull = ( data[3] == null );
                this.typeID = typeIDNull ? 0 : Str.toInt( data[3] );
                this.owner = data[4];
        ...
        public void setTypeIDNull( boolean typeIDNull )
        {
            this.typeIDNull = typeIDNull ;
            if ( typeIDNull )
            {
                typeID = 0 ;
            }
        ...
        private Map buildDataMap()
        {
            ...
            data.put( typeIDColumnName , this.typeIDNull ? null : String.valueOf( this.typeID ) );
