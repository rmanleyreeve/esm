...
/** Strongly typed access to the database table "VESSEL_TYPES".
 *
 ...
 *
 */
public class VesselTypesTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "VESSEL_TYPES";
    ...
    {
        idColumnName , categoryIDColumnName , nameColumnName , createdDateColumnName , deletedColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockVesselTypesTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( VesselTypesTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Row( String[] data )
        {
            if ( data != null )
            {
                ...
                this.categoryID =  Str.toInt( data[1] );
                this.name = data[2];
        ...
        private Map buildDataMap()
        {
            ...
            data.put( categoryIDColumnName , String.valueOf(  this.categoryID ) );
