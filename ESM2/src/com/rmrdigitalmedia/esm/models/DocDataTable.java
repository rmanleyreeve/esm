 ...
 *
 */
public class DocDataTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "DOC_DATA";
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockDocDataTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( DocDataTable.Implementation instance  )
    {
        imp = instance ;
    }
