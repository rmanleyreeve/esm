 ...
 *
 */
public class EntrypointsTable
{

    private static Implementation imp = new Implementation();

    public static final String tableName = "ENTRYPOINTS";
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockEntrypointsTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( EntrypointsTable.Implementation instance  )
    {
        imp = instance ;
    }
