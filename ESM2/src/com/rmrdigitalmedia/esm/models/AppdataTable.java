...
/** Strongly typed access to the database table "APPDATA".
 *
...
public class AppdataTable
{
    ...
    public static final String tableName = "APPDATA";

    public static final String idColumnName = "ID";
    public static final String keyColumnName = "KEY";
    public static final String valueColumnName = "VALUE";

    private static String[] allColumns =
    {
        idColumnName , keyColumnName , valueColumnName , 
    };
     ...
     *  you wanted to.
     *  
     *  To use this in your unit testing, create an instance of MockAppdataTable and pass
     *  it in here.  Then set your mock return values, call the method you are testing and examine
     *  the mock values that are now set!
     */
    public static void setInstance( AppdataTable.Implementation instance  )
    {
        imp = instance ;
    }
    ...
    public static class Row
    {
        ...
        private Map buildDataMap()
        {
            ...
            data.put( keyColumnName , this.key );
